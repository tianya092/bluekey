<%@ page language="java"
	import="com.bluekey.connDb,com.bluekey.Role,java.util.*,java.io.*"
	contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%  
	String email = (String)session.getAttribute("email");
	String query_function = request.getParameter("function");
	String query_team = request.getParameter("team");
			...
			<form class="form-horizontal" id="detail_form" method="post"
				...
				<div id="select_role" class="col-md-11">
					<div>
						...
						<div class="col-sm-2">
							<select class="function form-control role-select" name="function"
								data-value="<%=query_function %>" data-required="false"
								data-first-title="Select function"></select>
						</div>
					</div>
					<div>
						<label for="inputParent_part"
				...
				<div class="col-md-1">
					<button class="btn btn-info btn">Query</button>
				</div>
			</form>
		</div>
